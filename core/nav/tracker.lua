local plugin_label = 'wm_nav_explorer'
...
tracker.bench_report = function()
    ...
    if tracker.bench_first_report then
        console.print("[WM-NAV PERF] Benchmark enabled - reporting every " .. tracker.bench_report_interval .. "s")
    ...
    console.print(string.format("[WM-NAV PERF] === %.1fs window ===", window))
